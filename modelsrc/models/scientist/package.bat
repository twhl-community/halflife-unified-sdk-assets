...
if exist %basename%_ld_bshift.mdl xcopy /F /Y %basename%_ld_bshift.mdl %~dp0..\..\mdl\ld\bshift\%basename%.mdl*
...
if exist %basename%_ld_bshift.mdl xcopy /F /Y %basename%_ld_bshift.mdl %~dp0..\..\mdl\ld\bshift\civ_%basename%.mdl*
